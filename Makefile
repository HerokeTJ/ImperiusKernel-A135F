...
# ARCH		?= $(SUBARCH)
ARCH		?= arm64
CROSS_COMPILE ?= $(srctree)/Clang-toolchains/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-
...
CC		= $(srctree)/Clang-toolchains/clang/host/linux-x86/clang-r416183d/bin/clang
LD		= $(CROSS_COMPILE)ld
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
